...
int main()
{
    ...
    int extra_bits=0;
    std::cout<<"__________________________Start solo Haffman encryption____________________________"<<std::endl;
    ...
    std::cout<<"__________________________Finish solo Haffman encryption____________________________"<<std::endl<<std::endl<<std::endl;

    std::cout<<"_____________________________Start solo RLE encryption______________________________"<<std::endl;
    ...
    std::cout<<"________________________Finish solo RLE enctyption___________________________"<<std::endl<<std::endl<<std::endl;

    std::cout<<"_________________________Start complex encryption___________________________"<<std::endl;
    ...
    std::cout<<"_________________________Finish complex encryption___________________________"<<std::endl;
